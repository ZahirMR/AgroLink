...
import { ShoppingCart, Filter, MapPin, Star, Truck, Banknote, QrCode, CreditCard } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-600 mb-8">Compra directamente a agricultores locales</p>
        ...
        {!loading && (
          <>
            ...
            {/* Cart Summary */}
            {cart.length > 0 && (
              <div className="mb-8 bg-green-50 p-4 rounded-lg flex items-center justify-between shadow-sm">
